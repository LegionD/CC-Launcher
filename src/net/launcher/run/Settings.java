...
public class Settings
{
	...
	public static boolean useModCheckerTimer	 =  true;   //Перепроверка модов через 30 секунд
	public static int     useModCheckerint       =  2;      //Количество рас пеепроверки модов во времяигры
