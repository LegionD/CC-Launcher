...
public class LoginTheme
{
	...
	public static ComboboxStyle	servers         = new ComboboxStyle(185, 480, 245, 24, "font", "combobox", 14F, Color.WHITE, true, Align.CENTER);
	public static ServerbarStyle    serverbar	= new ServerbarStyle(450, 485, 380, 16, "font", 16F, Color.WHITE, true);
